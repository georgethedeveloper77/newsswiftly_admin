            ...
            <div class="feature-img-thumb relative">
              <div class="video-box">
                ...
                <div id="thumbnail_container" class="thumbnail_container">
                   <iframe width="560" height="315" src="http://www.youtube.com/embed/<?php echo $post->content; ?>" frameborder="0" allowfullscreen></iframe>
                </div>
              </div>
            </div>
              ...
              <div class="container">
                <div class="row flex-column">
                  ...
                  *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                  ...
                  this.page.url = "<?php echo site_url().'video/'.$post->id; ?>";  // Replace PAGE_URL with your page's canonical URL variable
        ...
        <div class="sidebars-area">
          ...
          <div class="single-sidebar-widget editors-pick-widget">
            ...
            <div class="editors-pick-post">
              ...
              <div class="details">
                <a href="<?php echo site_url().'video/'.$related[0]->id; ?>">
            ...
            <?php } ?>
              <div class="post-lists">
                ...
                <div class="single-post d-flex flex-row">
                  ...
                  <div class="detail">
                    <a href="<?php echo site_url().'video/'.$related[$i]->id; ?>"><h6><?php echo $related[$i]->title; ?></h6></a>
                    <ul class="meta">
