                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          ...
                          <form method="POST" action="<?php echo base_url(); ?>savenewlivestream">
                                ...
                                <div class="form-line">
                                  <label>LiveStream Source</label>
                                    <select class="form-control" name="type">
                                        ...
                                        <option value="youtube" selected> Youtube LiveVideo ID</option>
                            ...
                            <div class="input-group addon-line" style="margin-top:20px;">
                                   <label>LiveTv ID</label>

                                <div class="form-line">
                                    <input type="text" class="form-control" name="source" placeholder="LiveTv id" autofocus="">
                                </div>

                            </div>


                            <div class="addon-line" style="margin-top:20px;" style="display:none;">
