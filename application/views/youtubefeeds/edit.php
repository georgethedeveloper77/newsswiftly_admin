                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                          ...
                          <form method="POST" action="<?php echo base_url(); ?>editYoutubeFeedData">
                            ...
                            <div class="form-line">
                                <select id="source" class="form-control" name="source" required="" autofocus="">
                                  <?php foreach ($source as $res) { ?>
                                    <option <?php echo $feed->channel==$res->source?"selected":""; ?> data-location="<?php echo $res->location; ?>" data-lang="<?php echo $res->lang; ?>" data-interest="<?php echo $res->category; ?>" value="<?php echo $res->id; ?>">
                                      <?php echo $res->source; ?></option>
                                  <?php  } ?>
                                </select>
                            </div>
                            ...
                            <div class="input-group addon-line">
                              ...
                              <div class="input-group addon-line" style="margin-top:15px;">
                                  ...
                                  <div class="form-line">
                                      <textarea type="text" class="form-control" name="content" rows="1" placeholder="Youtube Video ID" required="" autofocus=""><?php echo $feed->content; ?></textarea>
                                  </div>
                              </div>
                            ...
                            <div class="box-footer text-center">
                               <button class="btn btn-primary waves-effect" type="submit">UPDATE YOUTUBE FEED</button>
                            </div>
