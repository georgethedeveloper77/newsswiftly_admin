                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                          ...
                          <form method="POST" action="<?php echo base_url(); ?>saveNewYoutubeFeed">
                            ...
                            <div class="input-group addon-line">
                              ...
                              <div class="input-group addon-line" style="margin-top:15px;">
                                  ...
                                  <div class="form-line">
                                      <textarea type="text" class="form-control" name="content" rows="1" placeholder="Youtube Video ID" required="" autofocus=""></textarea>
                                  </div>
                              </div>
                            ...
                            <div class="box-footer text-center">
                               <button class="btn btn-primary waves-effect" type="submit">SAVE NEW YOUTUBE FEED</button>
                            </div>
