                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                          ...
                          <form method="POST" action="<?php echo base_url(); ?>editRssLinkData">
                            <input type="hidden" name="id" value="<?php echo $link->id; ?>">
                            <div class="addon-line" style="margin-top:15px;">
                                <div class="form-line">
                                  <label>Select rss country(only users from selected country will be able to pull feeds from this link)</label>
                            ...
                            <div class="addon-line" style="margin-top:15px;">
                              ...
                              <div class="addon-line">
                                  ...
                                  <div class="form-line">
                                      <label>Select rss link type</label>
                                      <select class="form-control" name="rss_type" required="" autofocus="">
                                        <option value="webpage" <?php echo $link->rss_type=="webpage"?"selected":""; ?>>WebPage Link</option>
                                        <option value="rsspage" <?php echo $link->rss_type=="rsspage"?"selected":""; ?>>RSS Page Link</option>
                                      </select>
                                  </div>
                              </div>
                            ...
                            <div class="box-footer text-center">
                               <button class="btn btn-primary waves-effect" type="submit">UPDATE RSS LINK</button>
                            </div>
