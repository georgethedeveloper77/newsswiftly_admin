                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                          ...
                          <form method="POST" action="<?php echo base_url(); ?>saveNewRssLink">
                            ...
                            <div class="addon-line" style="margin-top:15px;">
                                <div class="form-line">
                                  ...
                                  <select class="form-control form-control-sm" name="location" required="" autofocus="">
                                ...
                                <div class="form-line">
                                  <label>Set Rss Interest</label>
                                    <select class="form-control" name="category" required="" autofocus="">
                                      <option value="">select rss link interest</option>
                                  ...
                                  <div class="form-line">
                                    <label>Select rss link type</label>
                                      <select class="form-control" name="rss_type" required="" autofocus="">
                                        ...
                                        <option value="rsspage">RSS Page Link</option>
                                      </select>
                                  </div>
                              </div>
                            ...
                            <div class="box-footer text-center">
                               <button class="btn btn-primary waves-effect" type="submit">SAVE NEW RSS LINK</button>
                            </div>
