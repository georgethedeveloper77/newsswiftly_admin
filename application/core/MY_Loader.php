...
class MY_Loader extends CI_Loader {
    ...
    public function blogtemplate($template_name, $vars = array(), $return = FALSE)
    {
      $S3Header = $this->view('templates/blogheader', $vars, $return); // header
      $S3Content = $this->view($template_name, $vars, $return); // view
      $S3Footer = $this->view('templates/blogfooter', $vars, $return); // footer
